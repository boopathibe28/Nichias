...
public class HomeListViewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initialView() {
        ...
        BounceView.addAnimTo(binding.lyoutRemnant);
        ...
        binding.lyoutRemnant.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        else if (view == binding.lyoutInspection){
            CommonFunctions.getInstance().newIntent(HomeListViewActivity.this, InspectionActivity.class, Bundle.EMPTY, false, false);
        }
        ...
        else if (view == binding.lyoutRemnant){
            CommonFunctions.getInstance().newIntent(HomeListViewActivity.this, RemnantActivity.class, Bundle.EMPTY, false, false);
        }
    }
